...
const AnimatedGallery = () => {
    ...
    return (
        <div>
            ...
            <button onClick={handleClick} className="mb-8 p-4 rounded-lg bg-yellow-300 text-black font-bold">
            ...
            >
                {
                    galleryImages.map((image, index) => (
                        <motion.img src={image} alt={`Gallery Image ${index + 1}`} className="ml-8 w-300 rounded"
